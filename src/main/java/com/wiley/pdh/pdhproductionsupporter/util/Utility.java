...
public class Utility {
    ...
    public static final String INFO_ARTICLE_TAGS_SUCCESSFULLY_UPDATED = "Article tags updated successfully for Article with 'DH_PROD_ID': {%d} %n SurvivorShipLog: {%s}";
    ...
    public static final String EX_PRODUCT_DATES_XREF_DOES_NOT_EXISTING_IN_C_PRODUCT_DATES_XREF = "ProductDatesXref with DH_PRODREG_ID: {%d} and DH_EXT_ID: {%d} (REF_CD: {%s}) doesn't exist in 'C_PRODUCT_DATES_XREF' table.";
    public static final String EX_PRODUCT_DATES_DOES_NOT_EXISTING_IN_C_PRODUCT_DATES = "ProductDates with DH_PRODREG_ID: {%d} and DH_EXT_ID: {%d} (REF_CD: {%s}) doesn't exist in 'C_PRODUCT_DATES' table.";
    public static final String EX_PRODUCT_EXTENSION_DOES_NOT_EXISTING_IN_C_PRODUCT_EXTENSION = "ProductExtension with DH_PRODREG_ID: {%d} and DH_EXT_ID: {%d} (REF_CD: {%s}) doesn't exist in 'C_PRODUCT_EXTENSION' table.";
    public static final String EX_PRODUCT_EXTENSION_XREF_DOES_NOT_EXISTING_IN_C_PRODUCT_EXTENSION_XREF = "ProductExtensionXref with DH_PRODREG_ID: {%d} and DH_EXT_ID: {%d} (REF_CD: {%s}) doesn't exist in 'C_PRODUCT_EXTENSION_XREF' table.";
